...
private:
        ...
        // isLeaf
        // takes a pointer to a node and returns a bool
        // returns true if the node is a leaf, false otherwise
        bool isLeaf(Node *np) const;

        // newNode
        // takes an integer value and returns a Node pointer
        // creates a new node with a given int and null pointers
        Node * newNode(int value) const;

        // removeWithOneChild
        // takes two node pointers
        // removes a node with one child
        void removeWithOneChild(Node * parent, Node * node) const;

        // removeLeaf
        // takes two node pointers
        // removes a leaf
        void removeLeaf(Node * parent, Node * node) const;
